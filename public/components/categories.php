...
<script>
    ...
    // Fetch all categories with enriched=true
    const fetchCategories = async () => {
        try {
            const res = await fetch(`${API_BASE}?enriched=true`, {
    ...
    const fetchCategory = async (id) => {
        try {
            const res = await fetch(`${API_BASE}?id=${id}&enriched=true`, {
                credentials: "same-origin"
            });
            ...
            console.warn("Failed to load category:", id);
            return null;
        }
    };
            ...
            <div class="category-card">
                ...
                <div class="category-info">
                    ...
                    <div class="category-actions">
                        <a href="<?= BASE_URL ?>category.php?id=${cat.id}" target="_blank" id="browse">
