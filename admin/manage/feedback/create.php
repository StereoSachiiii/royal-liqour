...
<script type="module">
import { fetchHandler, API_FEEDBACK , API_URL} from '../utils.js';
...
const populateUsers = async () => { 
    const users = await fetchHandler(`${API_URL}?entity=users&`, 'GET');
...
const populateProducts = async () => { 
    const products = await fetchHandler(`${API_URL}?entity=products&`, 'GET');
