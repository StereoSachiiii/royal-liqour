...
<body>
    ...
    <script type="module">
        const API_URL = 'http://localhost/royal-liquor/admin/api/admin-views.php'; // Not used in this script
        const API_COCKTAIL_RECIPE = 'http://localhost/royal-liquor/admin/api/cocktail-recipes.php';
        ...
        form.addEventListener('submit', async e => {
            ...
            try {
               ...
               // const imageUrl = await uploadImageAndGetURL(imageFile); 
                ...
                const res = await fetch(API_COCKTAIL_RECIPE, {
                    method: 'POST',
