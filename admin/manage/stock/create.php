...
<body>
    ...
    <script type="module">
        import { fetchHandler, API_URL } from '../utils.js';
        ...
        async function populateProducts() {
            try {
                const res = await fetchHandler(`${API_URL}?entity=products&limit=1000`, 'GET');
        ...
        async function populateWarehouses() {
            try {
                const res = await fetchHandler(`${API_URL}?entity=warehouses&limit=500`, 'GET');
