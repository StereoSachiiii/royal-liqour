...
<body>
    ...
    <script type="module">
        ...
        const API_STOCK = 'http://localhost/royal-liquor/admin/api/stock.php';
        ...
        async function loadWarehouses() {
            try {
                const res = await fetchHandler(`${API_URL}?entity=warehouses&limit=500`);
        ...
        async function loadStock() {
            try {
                const data = await fetchHandler(`${API_URL}?entity=stock&id=${recordId}`);
        ...
        async function loadProductStockBreakdown(productId) {
            try {
                const res = await fetchHandler(`${API_URL}?entity=stock&limit=100`);
