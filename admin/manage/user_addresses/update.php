...
<body>
    ...
    <script type="module">
        ...
        const API_USER_ADDRESS = 'http://localhost/royal-liquor/admin/api/addresses.php';
        ...
        const loadUrl = `${API_URL}?entity=user_addresses&id=${recordId}`;
        ...
        form.addEventListener('submit', async e => {
            ...
            try {
                const response = await fetch(API_USER_ADDRESS, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                    credentials: 'same-origin',
