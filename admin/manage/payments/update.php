...
<body>
    ...
    <script type="module">
        ...
        const API_PAYMENT = 'http://localhost/royal-liquor/admin/api/payments.php';
        ...
        const loadUrl = `${API_URL}?entity=payments&id=${recordId}`;
        ...
        async function loadOrders() {
            try {
                const response = await fetch(`${API_URL}?entity=orders&limit=500`, {
                    method: 'GET',
