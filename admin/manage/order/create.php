...
<body>
    ...
    <script type="module">
        ...
        const API_ORDER = 'http://localhost/royal-liquor/admin/api/orders.php';
        const API_ADDRESS = 'http://localhost/royal-liquor/admin/api/addresses.php';
        ...
        async function loadUsers() {
            try {
                const response = await fetch(`${API_URL}?entity=users&limit=500`, {
                    method: 'GET',
        ...
        async function loadCarts() {
            try {
                const response = await fetch(`${API_URL}?entity=carts&limit=500`, {
                    method: 'GET',
                    headers: { 'Content-Type': 'application/json' },
                    credentials: 'same-origin'
                });
