...
import { getTastePreferences, saveTastePreferences, calculateMatchScore } from '<?= BASE_URL ?>utils/preferences-storage.js';
...
const savePreferences = () => {
    ...
    const success = saveTastePreferences(values);
