...
const openOrderModal = async (orderId) => {
  ...
  const res = await fetch(`http://localhost/royal-liquor/admin/api/orders.php?id=${orderId}&enriched=true`);
...
document.getElementById('cancelOrderBtn').onclick = async () => {
  ...
  const res = await fetch(`http://localhost/royal-liquor/api/order.php?id=${currentOrderId}&action=cancel`, {method:'POST'});
  const json = await res.json();
  if (json.success) {
