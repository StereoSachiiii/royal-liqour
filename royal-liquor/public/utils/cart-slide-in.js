    ...
    if (!document.getElementById('cartSlideIn')) {
        ...
        slideIn.innerHTML = `
            ...
            <div class="slide-in-footer">
                <a href="${window.BASE_URL || '/royal-liquor/public/'}cart.php" class="btn-view-cart">View Cart</a>
                <a href="${window.BASE_URL || '/royal-liquor/public/'}checkout.php" class="btn-checkout-now">Checkout</a>
            </div>
        `;
...
export const showCartSlideIn = (product, quantity, cartTotal, cartCount) => {
    ...
    content.innerHTML = `
        <div class="slide-in-item">
            <img src="${product.image_url}" alt="${product.name}" class="slide-in-item-image">
