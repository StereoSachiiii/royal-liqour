...
function loadPageCSS($pageName = 'home') {
    ...
    // Always load utilities first (base styles)
    echo "    <link rel=\"stylesheet\" href=\"" . BASE_URL . "css/utilities.css\">\n";
    
    // Get CSS files for this page, default to home if not found
    $cssFiles = $PAGE_CSS[$pageName] ?? $PAGE_CSS['home'];
    
    // Output CSS link tags
    foreach ($cssFiles as $file) {
        echo "    <link rel=\"stylesheet\" href=\"" . BASE_URL . "css/{$file}.css\">\n";
    }
}
