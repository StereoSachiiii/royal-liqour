...
// Base URL - all API requests use /api/v1 prefix
...
export const API_ROUTES = {
    ...
    PRODUCT_RECOGNITION: {
        LIST: `${BASE_URL}/product-recognition`,
        SEARCH: `${BASE_URL}/product-recognition/search`,
        GET: (id) => `${BASE_URL}/product-recognition/${id}`,
        CREATE: `${BASE_URL}/product-recognition`,
        UPDATE: (id) => `${BASE_URL}/product-recognition/${id}`,
        DELETE: (id) => `${BASE_URL}/product-recognition/${id}`
    },

    // Special endpoints (direct file access, not through router)
    IMAGES: {
        UPLOAD: '/royal-liquor/admin/api/images.php'
    },
