...
class AddressRepository extends BaseRepository
{
    ...
    {
        $sql = "INSERT INTO user_addresses (user_id, address_type, address_line1, address_line2, 
    ...
    public function update(int $id, array $data): ?AddressModel
    {
        ...
        foreach (['address_type', 'address_line1', 'address_line2', 'city', 'state', 'postal_code', 'country', 'is_default'] as $col) {
            if (isset($data[$col])) {
                $sets[] = "$col = :$col";
                $params[":$col"] = $data[$col];
            }
